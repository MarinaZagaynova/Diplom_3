...
class LkPage(BasePage):
    ...
    @allure.step("Ожидание загрузки странице авторизации")
    def wait_login(self):
    ...
    def check_lk_page(self):
        assert self.get_text_from_element(LkPageLocators.history_order) == "История заказов"
